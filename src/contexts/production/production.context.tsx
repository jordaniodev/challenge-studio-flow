...
import { ProductionActionType, type Production, type ProductionAction, type ProductionState } from "./production.type"
...
const setProductions: Handler<Extract<ProductionAction, { type: ProductionActionType.SET_PRODUCTIONS }>> = (state, action) => ({
  ...state,
  productions: action.payload,
})

const selectProduction: Handler<Extract<ProductionAction, { type: ProductionActionType.SELECT_PRODUCTION }>> = (state, action) => ({
  ...state,
  selectedProduction: action.payload,
})

const unselectProduction: Handler<Extract<ProductionAction, { type: ProductionActionType.SELECT_PRODUCTION }>> = (state) => ({
  ...state,
})

const setLoading: Handler<Extract<ProductionAction, { type: ProductionActionType.SET_LOADING }>> = (state, action) => ({
  ...state,
  isLoading: action.payload,
})

const setError: Handler<Extract<ProductionAction, { type: ProductionActionType.SET_ERROR }>> = (state, action) => ({
  ...state,
